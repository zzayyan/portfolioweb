  ...
  return (
    <div className="min-h-screen bg-black text-white page-transition">
      ...
      <section className="flex flex-col items-center justify-center min-h-screen px-4 text-center border-b border-white/10">
        <div className="w-28 h-28 mb-10 flex items-center justify-center rounded-full border border-white/20 text-3xl font-semibold tracking-[0.35em]">
          YM
        </div>
        ...
        <p className="text-base md:text-lg text-gray-500 mb-10 max-w-2xl leading-relaxed">
          I craft thoughtful digital products with clean interfaces, clear systems,
          and reliable engineering. Every project balances usability, visual clarity,
      ...
      <section className="py-20 px-4 border-b border-white/10">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-sm uppercase tracking-[0.4em] text-gray-500 text-center mb-12">Capabilities</h2>

          <div className="grid md:grid-cols-3 gap-6">
            {[
              ["Frontend Development", "Interfaces that balance brand expression with crisp usability across devices."],
              ["Backend Development", "APIs and systems that stay predictable, secure, and easy to extend."],
              ["Product & Experience", "End-to-end thinking from structure and flows to polished micro-interactions."]
            ].map((item, index) => (
              <div
                key={index}
                className="rounded-xl border border-white/10 bg-black/40 p-8 flex flex-col gap-4 hover:bg-white/5 transition-colors"
              >
                <span className="text-xs uppercase tracking-[0.35em] text-gray-500">0{index + 1}</span>
      ...
      <section className="py-20 px-4 border-b border-white/10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: "Project One", description: "A modern web application built with React and Node.js", tags: ["React", "Node.js"] },
              { title: "Project Two", description: "E-commerce platform with advanced features", tags: ["Next.js", "MongoDB"] },
              { title: "Project Three", description: "Mobile-first design system and components", tags: ["Vue.js", "Tailwind"] }
            ].map((project, index) => (
              <div
                key={index}
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-light tracking-tight mb-6">Let&apos;s Build Together</h2>
          <p className="text-gray-500 max-w-2xl mx-auto mb-10">
            I&apos;m open to new collaborations, product challenges, and conversations about thoughtful design systems.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 px-6 py-3 rounded-full border border-white/20 text-sm uppercase tracking-[0.3em] text-white hover:bg-white hover:text-black btn-click btn-smooth"
            >
              in<span className="sr-only">LinkedIn</span> linkedin.com/in/yourprofile
            </a>
            <a
              href="https://github.com/yourusername"
              className="flex items-center justify-center gap-3 px-6 py-3 rounded-full border border-white/20 text-sm uppercase tracking-[0.3em] text-white hover:bg-white hover:text-black btn-click btn-smooth"
            >
              &lt;&gt;<span className="sr-only">GitHub</span> github.com/yourusername
            </a>
          </div>
        </div>
      </section>
